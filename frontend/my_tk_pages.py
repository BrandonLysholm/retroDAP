...
class tkinterApp(tk.Tk): 
    ...
    def __init__(self, *args, **kwargs):  
        ...
        for F in (StartPage, NowPlayingFrame, SearchFrame, PowerFrame): 
...
class PowerFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.confirmation_label = tk.Label(contentFrame, text ="Press Center Button to confirm shutdown", font = MED_FONT, background=SPOT_BLACK, foreground=SPOT_GREEN, wraplength=800)
